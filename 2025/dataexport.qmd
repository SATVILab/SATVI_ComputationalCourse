...
**Numeric** - Minimum, 1st quartile, median, mean, 3rd quartile, maximum **Factor** - Counts of each level **Logical** - Counts of TRUE, FALSE, and NA **Character** - Converts to a factor and shows counts (with a warning) **Date** - Minimum and maximum dates
